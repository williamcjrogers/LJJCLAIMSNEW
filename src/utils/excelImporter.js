    ...
    try {
      ...
      Object.entries(headsData).forEach(([headId, rows]) => {
        ...
        importedHeads[headId] = {
          ...
          success_probability: this.parseNumber(
            this.getValue(firstRow, mapping.success_probability)
          ),
  ...
  generateTemplate() {
    const template = [
      ...
      [
        'SVP_001',
        'SVP Systems',
        'Soil Vent Pipe installation failures',
        '1670000',
        '75',
        '92',
        'active',
        'SVP_001_1',
        'Technical Failures',
        '28 installation defects identified',
        '890000',
        'strong',
        'Leaking connections; Missing seals; Poor workmanship',
        'K&T Report; Photos; Drawings',
        '2024-01-07',
        'K&T Investigation',
