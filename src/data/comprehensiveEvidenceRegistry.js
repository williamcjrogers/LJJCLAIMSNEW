...
export const comprehensiveEvidenceRegistry = {
  ...
  headsOfClaim: {
    ...
    'Building Management System': {
      ...
      defects: [
        'HIU safety valve non-compliance',
        'MVHR switching issues',
        'Interface failures'
      ],
      evidenceFolders: {
        'Design': {
        ...
        'NCRs': {
          ...
          files: [
            '20240410122010738.pdf',
            'ULG-NCR-000067 BMS.pdf'
          ]
        },
        'Correspondence': {
  ...
  ncrs: {
    'Part 1': {
      ...
      files: [
        'LJJ NCR 1.pdf', 'LJJ NCR 2.pdf', 'LJJ NCR 3.pdf', 'LJJ NCR 4.pdf',
        'LJJ NCR 5.pdf', 'LJJ NCR 6.pdf', 'LJJ NCR 7.pdf', 'LJJ NCR 8.pdf',
        'LJJ NCR 9.pdf', 'LJJ NCR 10.pdf', 'LJJ NCR 11.pdf', 'LJJ NCR 12.pdf',
        'LJJ NCR 13.pdf', 'LJJ NCR 14.pdf', 'LJJ NCR 15.pdf', 'LJJ NCR 16.pdf',
        'LJJ NCR 17.pdf', 'LJJ NCR 18.pdf', 'LJJ NCR 19.pdf', 'LJJ NCR 20.pdf',
        'LJJ NCR 21.pdf', 'LJJ NCR 22.pdf', 'LJJ NCR 23.pdf'
      ]
    },
    'Part 2': {
      path: 'LJJ NCRs\' Part 2',
      files: [
        'ULG-NCR-000019.pdf', 'ULG-NCR-000026.pdf', 'ULG-NCR-000028.pdf',
        'ULG-NCR-000029.pdf', 'ULG-NCR-000030.pdf', 'ULG-NCR-000031.pdf',
        'ULG-NCR-000032.pdf', 'ULG-NCR-000033.pdf', 'ULG-NCR-000034.pdf',
        'ULG-NCR-000035.pdf', 'ULG-NCR-000036.pdf', 'ULG-NCR-000037.pdf',
        'ULG-NCR-000038.pdf', 'ULG-NCR-000039.pdf', 'ULG-NCR-000040.pdf',
        'ULG-NCR-000042.pdf', 'ULG-NCR-000043.pdf', 'ULG-NCR-000044.pdf',
        'ULG-NCR-000045.pdf', 'ULG-NCR-000046.pdf', 'ULG-NCR-000047.pdf',
        'ULG-NCR-000048.pdf', 'ULG-NCR-000049.pdf', 'ULG-NCR-000050.pdf',
        'ULG-NCR-000051.pdf', 'ULG-NCR-000052.pdf', 'ULG-NCR-000053.pdf',
        'ULG-NCR-000054.pdf', 'ULG-NCR-000055.pdf', 'ULG-NCR-000056.pdf',
        'ULG-NCR-000057.pdf', 'ULG-NCR-000058.pdf', 'ULG-NCR-000061.pdf',
        'ULG-NCR-000064.pdf'
      ]
    }
  },
...
export function isFileViewable(filename) {
  const viewableExtensions = ['.pdf', '.jpg', '.jpeg', '.png', '.gif', '.txt', '.csv', '.xlsx', '.xls', '.doc', '.docx'];
...
export function searchEvidence(keyword) {
  ...
  for (const [headName, headData] of Object.entries(comprehensiveEvidenceRegistry.headsOfClaim)) {
    if (headName.toLowerCase().includes(searchTerm) || 
