      ...
      subClaims: [
        ...
        },
        {
          ...
          items: [
            ...
            { description: 'MVHR commissioning and remediation', amount: 65200.2 },
            { description: 'MVHR summer bypass installation', amount: 23791.23 },
            { description: 'Replacement of 6 MVHR units', amount: 18961.8 },
          ],
        },
        {
          id: 'sc3-3',
      ...
      subClaims: [
        ...
        },
        {
          ...
          items: [
            ...
            { description: 'Emergency shut off valves', amount: 5475.6 },
      ...
      subClaims: [
        {
          ...
          items: [
            ...
            { description: 'Trace heat and insulate', amount: 23466.2 },
          ],
        },
        {
          id: 'sc6-2',
