        ...
        mechanical_building_services: {
            ...
            sub_claims: {
                chlorination: {
                    ...
                    claim_value: 170000,
                    status: 'medium',
                    evidence_items: ['Water test results', 'Chlorination reports', 'Compliance documentation'],
                    defects: ['System performance failures', 'Non-compliance with standards', 'Poor installation']
                },
                duplex_9: {
                    id: 'MBS-002',
                    title: 'Duplex 9',
                ...
                hiu: {
                    ...
                    claim_value: 200000,
                    status: 'strong',
                    evidence_items: ['HIU test certificates', 'Performance monitoring', 'Installation photos'],
                ...
                ufh: {
                    ...
                    claim_value: 150000,
                    status: 'medium',
                    evidence_items: ['UFH commissioning reports', 'Temperature monitoring', 'System drawings'],
        ...
        electrical: {
            ...
            sub_claims: {
                lightning_protection: {
                    ...
                    claim_value: 180000,
                    status: 'strong',
                    evidence_items: ['Lightning protection test results', 'Installation certificates', 'Safety documentation'],
                ...
                trace_heating: {
                    ...
                    claim_value: 100000,
                    status: 'medium',
                    evidence_items: ['Trace heating test results', 'Temperature monitoring', 'Installation records'],
        ...
        life_safety_systems: {
            ...
            sub_claims: {
                fire_alarm_system: {
                    ...
                    claim_value: 160000,
                    status: 'strong',
                    evidence_items: ['Fire alarm test certificates', 'Commissioning reports', 'Compliance documentation'],
                ...
                generator: {
                    ...
                    claim_value: 120000,
                    status: 'strong',
                    evidence_items: ['Generator test results', 'Performance monitoring', 'Maintenance records'],
        ...
        snagging_kilmurray: {
            ...
            sub_claims: {
                snagging: {
                    ...
                    defects: ['Outstanding snagging items', 'Defects requiring rectification', 'Quality issues']
                }
            }
        },
