...
import { comprehensiveEvidenceRegistry, getFullPath, isFileViewable, getFileType, getEvidenceByHeadOfClaim, searchEvidence } from '../data/comprehensiveEvidenceRegistry.js';
                ...
                <div class="evidence-card head-of-claim-card" data-head-id="${data.id}">
                    ...
                    <div class="card-content">
                        ...
                        <div class="defect-tags">
                            ${data.defects.slice(0, 3).map(d => `<span class="defect-tag">${d}</span>`).join('')}
