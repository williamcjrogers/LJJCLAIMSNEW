...
import { evidenceRegistry, getEvidenceByHeadId, getEvidenceCount } from '../data/evidenceRegistry.js';

export class EvidenceViewer {
    constructor() {
        this.currentEvidence = null;
        this.previewModal = null;
        this.basePath = 'C:/Users/William/Downloads/OneDrive_1_14-08-2025/LJJ - MEP Information Pack for DACB/WR New/';
    }
        ...
        return `
            <div class="evidence-library">
                ...
                <div class="evidence-categories">
                    ${Object.entries(evidence.evidenceCategories).map(([category, files]) => `
    ...
    getFileIcon(fileName) {
        ...
        switch(ext) {
            ...
            case 'jpeg':
            case 'png':
            case 'gif': return 'fas fa-file-image text-blue-500';
            case 'doc':
