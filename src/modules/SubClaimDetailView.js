...
import { getEvidenceForSubClaim } from '../data/evidenceRegistry.js';
        ...
        <div class="analysis-grid">
          <div class="analysis-card">
            ...
            <ul class="analysis-list strengths">
              ${this.getStrengths().map(s => `<li><i class="fas fa-check-circle"></i> ${s}</li>`).join('')}
            </ul>
          </div>
          ...
          <div class="analysis-card">
            ...
            <ul class="analysis-list weaknesses">
              ${this.getWeaknesses().map(w => `<li><i class="fas fa-exclamation-circle"></i> ${w}</li>`).join('')}
            </ul>
          </div>
          ...
          <div class="analysis-card">
            ...
            <ul class="analysis-list recommendations">
              ${this.getRecommendations().map(r => `<li><i class="fas fa-lightbulb"></i> ${r}</li>`).join('')}
            </ul>
          </div>
        </div>
        ...
        <div class="actions-container">
          ...
          <div class="timeline-preview">
            ...
            <div class="timeline-items">
              ${this.getRelatedTimelineEvents().map(event => `
  ...
  renderCharts() {
    ...
    if (ctx) {
      new Chart(ctx, {
        type: 'radar',
        data: {
          labels: ['Evidence Quality', 'Documentation', 'Timeline Consistency', 'Technical Merit', 'Legal Precedent'],
          datasets: [{
            label: 'Current Status',
            data: [
              this.subClaim.evidenceStrength,
              85,
              75,
              this.subClaim.successProbability,
              70
            ],
